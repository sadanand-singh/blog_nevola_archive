  ...
  return (
    <Section narrow>
      <SubscriptionContainer>
        <Content>
          <Heading>Join my email list and get notified about new content</Heading>
          <Text>
            Be the first to receive my latest content with the ability to opt-out at anytime. I
            promise to not spam your inbox or share your email with any third parties.
          </Text>
