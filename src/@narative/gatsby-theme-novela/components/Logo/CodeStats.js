 ...
 */
export default function CodeStatsLogo() {
  return (
    <LogoContainer>
      <svg width='42' height='32' viewBox='0 0 32 42'>
        <g transform='scale(0.12)'>
          <path
            class='a'
            d='M174,81.741v27.509C161.913,104,133.5,93.5,109.789,94.6c-23.859,1.107-42.172,7.301-54.859,21.902
	...
	c13.015-10.636,30.95-15.954,53.81-15.954c9.796,0,19.778,0.888,29.948,2.659C320.383,75.801,330.787,78.46,341.423,82.005z'
          ...
          <path
            class='a'
            d='M86.199,153.037c0-2.98,1.024-5.495,3.074-7.544c2.048-2.048,4.563-3.073,7.544-3.073c3.034,0,5.561,1.011,7.584,3.034
