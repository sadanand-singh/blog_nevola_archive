...
<div className='Image__Small'>
  <img
    src='https://res.cloudinary.com/sadanandsingh/image/upload/v1496963330/bakedPaneer_wxweem.jpg'
    alt='raw paneer'
  />
</div>
...
- After another minute or so, add salt, and keep stirring
  occasionally.
- Once the cauliflowers are almost cooked, add baked _Paneer_ pieces
  (about 3-5 minutes).
...
<div className='Image__Small'>
  <img
    src='https://res.cloudinary.com/sadanandsingh/image/upload/v1496963330/bakedPaneer_final_bh3rss.jpg'
    alt='prepared paneer'
  />
</div>
