...
hero: ./linear_reg.jpg
excerpt: "Modeling the relationship between a scalar response (or dependent variable)
...
<div className='Image__Small'>
  <img
    src='https://www.statisticssolutions.com/wp-content/uploads/2010/01/linearregression01.jpg'
    width='80px'
    height='80px'
    alt='p1'
  />
  <img
    src='https://www.statisticssolutions.com/wp-content/uploads/2010/01/linearregression02.jpg'
    width='80px'
    height='80px'
    alt='p2'
  />
...
<div className='Image__Small'>
  <img
    src='https://res.cloudinary.com/sadanandsingh/image/upload/v1545762679/Normal_normal_qq.svg_ptetvk.png'
    width='80px'
    height='80px'
    alt='p3'
  />
  <img
    src='https://res.cloudinary.com/sadanandsingh/image/upload/v1545762768/1920px-Normal_exponential_qq.svg_nrgiqh.png'
    width='80px'
    height='80px'
    alt='p4'
  />
...
<div className='Image__Small'>
  <img
    src='https://www.statisticssolutions.com/wp-content/uploads/2010/01/linearregression06.jpg'
    width='80px'
    height='80px'
    alt='p3'
  />
  <img
    src='https://www.statisticssolutions.com/wp-content/uploads/2010/01/linearregression07.jpg'
    width='80px'
    height='80px'
    alt='p4'
  />
...
In addition to these metrics, you can also take a look at some
[additional metrics in scikit-learn][sklearn-metrics].
...
<div className='Image__Small'>
  <img
    src='https://res.cloudinary.com/sadanandsingh/image/upload/v1545780650/poly_regress_srbjmr.png'
    alt='poly regression'
  />
</div>
...
<div className='Image__Small'>
  <img
    src='https://res.cloudinary.com/sadanandsingh/image/upload/v1545780346/smooth_rhpllc.png'
    alt='smooth regression'
  />
</div>
