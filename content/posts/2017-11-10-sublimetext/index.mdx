...
pallet. Hit `ctrl + shift + P` and type _Install_, choose _Package
...
<div className='Image__Medium'>
  <img
    src='https://res.cloudinary.com/sadanandsingh/image/upload/v1544988652/images/sublime/Settings.png'
    alt='sublime text'
  />
</div>
...
**sublack** is plugin to run black. [Black][black] is the uncompromising Python code formatter. Blackened
...
<div className='Image__Medium'>
  <img
    src='https://res.cloudinary.com/sadanandsingh/image/upload/v1544988652/images/sublime/MarkdownEditing.png'
    alt='sublime text markdown'
  />
</div>
